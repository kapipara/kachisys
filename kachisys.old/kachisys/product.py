...
def sw5Callback(pin):
    ...
    if not sw5flag:
        ...
        pwm.set_pwm(0,0, sv1_off)
        sleep(0.1)
        pwm.set_pwm(1,0, sv2_off)
        sleep(0.1)
        pwm.set_pwm(2,0, sv3_off)
        sleep(0.1)
        pwm.set_pwm(3,0, sv4_off)
        sleep(0.1)
        ...
        pwm.set_pwm(0,0, sv1_on)
        sleep(0.1)
        pwm.set_pwm(1,0, sv2_on) 
        sleep(0.1)
        pwm.set_pwm(2,0, sv3_on) 
        sleep(0.1)
        pwm.set_pwm(3,0, sv4_on) 
        sleep(0.1)
    else:
...
def initialize():
    ...
    pwm.set_pwm(0,0, sv_avoid)
    pwm.set_pwm(1,0, sv_avoid)
    pwm.set_pwm(2,0, sv_avoid)
    pwm.set_pwm(3,0, sv_avoid)
